...
"""
Taken from https://github.com/clarkerubber/Python-Puzzle-Creator/blob/master/modules/fishnet/fishnet.py
I have not written this code myself.
"""
...
def update_stockfish(filename):
    ...
    headers = {}
    headers["User-Agent"] = "Antichess-Cheat-Detector"
    ...
    for asset in release["assets"]:
        ...
        raise Exception("No precompiled %s for your platform" % filename)
